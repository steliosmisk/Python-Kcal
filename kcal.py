...
while user_choice in ['1', '2']:
    try:
        ...
        active = input("[?] Enter your activity (Sedentary, Lightly, Moderately, Active, VeryActive): ").lower()

        if user_choice == '1':
            mbr_results = 66.47 + (13.75 * weight) + (5.003 * height) - (6.755 * age)
        else:
            mbr_results = 655.1 + (9.563 * weight) + (1.850 * height) - (4.676 * age)
